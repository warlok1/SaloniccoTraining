		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#btpacademyeasyapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"btpacademyeasyapp-display": {
								"semanticObject": "btpacademyeasyapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=btp.academy.easyapp",
									"url": sap.ui.require.toUrl("btp/academy/easyapp")
								}
							}
						}
					}
